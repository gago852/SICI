      ...
      <div class="row">
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="py5 text-center">
             <p class="lead">Te informamos que no tienes las credenciales o los permisos  suficientes para la página que solicitaste, te invitamos a comunicarte con el Admin si consideras que es un error.</p>
          </div>
          <div class="py5 text-center">
