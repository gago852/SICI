...
<html lang="es">
  <head>
    ...
    <title>Editar Producto-TechProSys</title>
        <style type="text/css">
    ...
    <div class="container-fluid">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="text-center">
           <div class="esconder alert alert-success  alert-dismissible" id="esconder" style="margin-top:18px;">
              <a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
                <strong>Exito!</strong> Producto editado exitosamente.
           </div>
          <form class="needs-validation" action="registereditproduct.php" method="POST" novalidate>
          <input type="hidden" name="id" value="<?php echo $Idproduct; ?>">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" name="Descripcion" id="validationCustom02" value="<?php echo $description; ?>"  required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3 mb-3">
              ...
              <div class="input-group">
                <input type="number" class="form-control" name="precio" id="validationCustomUsername" value="<?php echo $price; ?>" aria-describedby="inputGroupPrepend" required>
                <div class="invalid-feedback">
                  Ingrese un precio
                </div>
                <div class="valid-feedback">
      ...
      <?php
        if (isset($_POST['tipo']) && isset($_POST['Descripcion'])) {
           require_once "conexion/conexion.php";
           require_once "registereditproduct.php";
         } 
    ?>
