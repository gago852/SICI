...
<html lang="es">
  <head>
    ...
    <title>Tipos de producto-TechProSys</title>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2  border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
              <div class="btn-group mr-2">
                <a href="newtype.php" class="btn btn-sm btn-outline-secondary"><span data-feather="plus-circle"></span> Nuevo Tipo</a>
              </div>
            </div>
            <?php } ?>
          </div>
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <?php                
                require_once 'conexion/conexion.php';
                $sql=$mysqli->query('select * from tipo_producto');                
                while($res=mysqli_fetch_array($sql)){
                ?>
              <tbody>
                <tr>
                  <td><?php echo $res["cod_typeproduct"]; ?></td>
